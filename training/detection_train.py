...
COMMENT = 'FacedModel, 9x9 grid, light version'
...
model = FacedModelLite(grid_size=grid_size, num_bboxes=num_bboxes).to(device)
...
dataset = DetectionDataset(transform=train_transform, grid_size=grid_size, num_bboxes=num_bboxes)
